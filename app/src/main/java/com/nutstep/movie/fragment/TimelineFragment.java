...
public class TimelineFragment extends Fragment {
    ...
    TimelineViewAdapter adapterTimeline;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragement_timeline, container, false);
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        recyclerViewTimeline = (RecyclerView) rootView.findViewById(R.id.recylerview_timeline);
        adapterTimeline = new TimelineViewAdapter();
